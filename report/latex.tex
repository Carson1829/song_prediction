...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{RFconf_mat.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.46\textwidth]{figure/result/KNN_Top_k_Accuracy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.46\textwidth]{figure/result/KNN_Weighted_Top_k_Accuracy.png}
